...
public class WebUtil {
    ...
    public static void writeJSON(HttpServletResponse response, JSONObject data) {
        try {
            ...
            writer.write(data.toJSONString()); // 转为 JSON 字符串
            writer.flush();
            writer.close();
        } catch (Exception e) {
        	CosplayLog.error("在响应中写数据出错！", e);
        }
    }
